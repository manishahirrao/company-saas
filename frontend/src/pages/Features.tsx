...
const features = [
  {
    title: 'Easy to Use',
    description: 'Intuitive interface that makes it simple for anyone to get started quickly.',
    icon: (
  ...
  },
  {
    ...
    description: 'Get detailed insights and reports to track your progress and make data-driven decisions.',
    icon: (
  ...
  },
  {
    ...
    description: 'Connect with your favorite tools and services with our powerful API.',
    icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-xl text-gray-500">
            Powerful features to help you work more efficiently and achieve your goals.
          </p>
        </div>
